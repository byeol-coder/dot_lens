...
export const SAMPLE_PACKAGES: TactileLessonPackage[] = [
  {
    ...
    localizationPacks: [
      ...
      { locale: "ko", localeName: "Korean",   uiLabels: {}, teacherGuide: "", studentInstructions: "", audioNarration: "", brailleLabelTerms: {}, subjectVocabulary: {}, localCurriculumNotes: "", status: "complete" },
      {
        ...
        uiLabels: { "find": "खोजें", "explore": "अन्वेषण करें", "next": "अगला", "reset": "रीसेट" },
        teacherGuide: "छात्रों को नीचे बाईं ओर से शुरू करने के लिए कहें। बीज से जड़, तना और पत्तों तक क्रमशः स्पर्श करके देखें। प्रत्येक चरण पर छात्र से पूछें कि उन्हें क्या महसूस हो रहा है।",
        studentInstructions: "नीचे बाईं ओर से शुरू करो। पहले बीज (S) ढूंढो, फिर जड़ (R), तना (T) और पत्ते (L) एक-एक करके छुओ।",
        audioNarration: "नीचे बाईं ओर से शुरू करें। बीज से जड़, तना और पत्तों तक एक-एक करके स्पर्श करें। यह पौधे की वृद्धि का क्रम है।",
        brailleLabelTerms: { S: "बीज", R: "जड़", T: "तना", L: "पत्ते" },
        subjectVocabulary: { plant: "पौधा", seed: "बीज", roots: "जड़", stem: "तना", leaves: "पत्ते", growth: "विकास", soil: "मिट्टी", water: "पानी" },
        localCurriculumNotes: "NCERT कक्षा 3 विज्ञान: पाठ 4 — पौधों का संसार। CBSE पाठ्यक्रम के अनुसार बीज अंकुरण और वृद्धि।",
        status: "complete",
      },
      {
        locale: "mr", localeName: "Marathi",
        uiLabels: { "find": "शोधा", "explore": "अन्वेषण करा", "next": "पुढे", "reset": "रीसेट" },
        teacherGuide: "विद्यार्थ्यांना खाली डाव्या बाजूने सुरुवात करायला सांगा. बीज, मुळे, खोड आणि पाने यांचा क्रमाने स्पर्श करा.",
        studentInstructions: "खाली डाव्या बाजूने सुरुवात करा. आधी बीज (S), नंतर मुळे (R), खोड (T) आणि पाने (L) स्पर्श करा.",
        audioNarration: "खाली डाव्या बाजूने सुरुवात करा. बीज ते पाने असा क्रम एक एक करून स्पर्श करून पहा.",
        brailleLabelTerms: { S: "बीज", R: "मुळे", T: "खोड", L: "पाने" },
        subjectVocabulary: { plant: "वनस्पती", seed: "बीज", roots: "मुळे", stem: "खोड", leaves: "पाने", growth: "वाढ" },
        localCurriculumNotes: "महाराष्ट्र राज्य अभ्यासक्रम इयत्ता 3 — वनस्पतींची वाढ. बालभारती विज्ञान पाठ्यपुस्तक.",
        status: "partial",
      },
      {
        locale: "bn", localeName: "Bengali",
        uiLabels: { "find": "খুঁজুন", "explore": "অন্বেষণ করুন", "next": "পরবর্তী", "reset": "রিসেট" },
        teacherGuide: "শিক্ষার্থীদের নিচের বাম দিক থেকে শুরু করতে বলুন। বীজ থেকে শিকড়, কান্ড এবং পাতা পর্যন্ত স্পর্শ করুন।",
        studentInstructions: "নিচের বাম দিক থেকে শুরু করো। প্রথমে বীজ (S), তারপর শিকড় (R), কান্ড (T) এবং পাতা (L) স্পর্শ করো।",
        audioNarration: "নিচের বাম দিক থেকে শুরু করুন। বীজ থেকে শিকড়, কান্ড এবং পাতা পর্যন্ত একে একে স্পর্শ করুন।",
        brailleLabelTerms: { S: "বীজ", R: "শিকড়", T: "কান্ড", L: "পাতা" },
        subjectVocabulary: { plant: "গাছ", seed: "বীজ", roots: "শিকড়", stem: "কান্ড", leaves: "পাতা", growth: "বৃদ্ধি" },
        localCurriculumNotes: "পশ্চিমবঙ্গ প্রাথমিক শিক্ষা পর্ষদ — তৃতীয় শ্রেণী, প্রকৃতি পরিচয়।",
        status: "partial",
      },
      {
        locale: "ar", localeName: "Arabic",
        uiLabels: { "find": "ابحث", "explore": "استكشف", "next": "التالي", "reset": "إعادة تعيين" },
        teacherGuide: "اطلب من الطلاب البدء من الركن الأيسر السفلي. استكشف من البذرة إلى الجذور ثم الساق ثم الأوراق.",
        studentInstructions: "ابدأ من الركن الأيسر السفلي. الجس البذرة (S)، ثم الجذور (R)، ثم الساق (T)، ثم الأوراق (L).",
        audioNarration: "ابدأ من الركن الأيسر السفلي. استكشف خطوة بخطوة من البذرة إلى الجذور والساق والأوراق.",
        brailleLabelTerms: { S: "بذرة", R: "جذور", T: "ساق", L: "أوراق" },
        subjectVocabulary: { plant: "نبات", seed: "بذرة", roots: "جذور", stem: "ساق", leaves: "أوراق", growth: "نمو" },
        localCurriculumNotes: "المنهج الدراسي للعلوم — الصف الثالث الابتدائي. دورة حياة النبات.",
        status: "pending",
      },
    ],
